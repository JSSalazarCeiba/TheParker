...
/**
 * Interface that handles database operations triggered by the fee calculator
 * task
 * 
 * @author juan.salazar
 *
...
public interface FeeCalculatorTaskDao {
	...
	/**
	 * Method to get the list of the records of the vehicles that are currently
	...
	/**
	 * Method to update the fields of parking time and charged fee for a given
	 * vehicle
	 * 
	 * @param timeToShow
	 * @param fee
