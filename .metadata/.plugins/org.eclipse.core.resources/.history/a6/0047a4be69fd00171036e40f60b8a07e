...
public class MainInfoEntity implements Serializable {
	...
	private static final long serialVersionUID = 6299112677511034558L;
	 ...
	 * @param payed
	 */
	public MainInfoEntity(String type, Integer currentOcuppation, Integer totalCapacity, Long toPay, Long payed) {
		super();
		this.type = type;
